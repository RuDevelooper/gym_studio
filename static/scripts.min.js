!function (t, e) {
    ...
    var e = [], C = E.document, i = Object.getPrototypeOf, a = e.slice, m = e.concat, l = e.push, r = e.indexOf, n = {},
        o = n.toString, v = n.hasOwnProperty, s = v.toString, c = s.call(Object), y = {}, _ = function (t) {
    ...
    T.fn = T.prototype = {
        jquery: h, constructor: T, length: 0, toArray: function () {
            return a.call(this)
        }, get: function (t) {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || _(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) i = t[e], "__proto__" !== e && s !== i && (c && i && (T.isPlainObject(i) || (r = Array.isArray(i))) ? (n = s[e], o = r && !Array.isArray(n) ? [] : r || T.isPlainObject(n) ? n : {}, r = !1, s[e] = T.extend(c, o, i)) : void 0 !== i && (s[e] = i));
        return s
    }, T.extend({
    ...
    var p = function (n) {
        ...
        var t, f, b, o, s, p, d, g, w, l, c, x, E, a, C, m, u, v, y, T = "sizzle" + 1 * new Date, _ = n.document, S = 0,
            i = 0, D = lt(), A = lt(), k = lt(), N = lt(), O = function (t, e) {
                return t === e && (c = !0), 0
            }, I = {}.hasOwnProperty, e = [], j = e.pop, L = e.push, P = e.push, H = e.slice, M = function (t, e) {
            ...
            W = "\\[" + q + "*(" + R + ")(?:" + q + "*([*^$|!~]?=)" + q + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + q + "*\\]",
            z = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)",
            F = new RegExp(q + "+", "g"), B = new RegExp("^" + q + "+|((?:^|[^\\\\])(?:\\\\.)*)" + q + "+$", "g"),
            U = new RegExp("^" + q + "*," + q + "*"), Q = new RegExp("^" + q + "*([>+~]|" + q + ")" + q + "*"),
            K = new RegExp(q + "|>"), V = new RegExp(z), Y = new RegExp("^" + R + "$"), X = {
                ID: new RegExp("^#(" + R + ")"),
                CLASS: new RegExp("^\\.(" + R + ")"),
                TAG: new RegExp("^(" + R + "|[*])"),
                ATTR: new RegExp("^" + W),
            ...
            }, G = /HTML$/i, Z = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, tt = /^[^{]+\{\s*\[native \w/,
            et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, nt = /[+~]/,
        ...
        function at(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : _) !== E && x(t), t = t || E, C)) {
                ...
                if (f.qsa && !N[e + " "] && (!m || !m.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                    if (u = e, h = t, 1 === d && K.test(e)) {
        ...
        for (t in f = at.support = {}, s = at.isXML = function (t) {
            ...
            if ((t.ownerDocument || t) !== E && x(t), f.matchesSelector && C && !N[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e))) try {
                var n = v.call(t, e);
            ...
            var n = b.attrHandle[e.toLowerCase()],
                i = n && I.call(b.attrHandle, e.toLowerCase()) ? n(t, e, !C) : void 0;
            ...
            var e, n = [], i = 0, r = 0;
            if (c = !f.detectDuplicates, l = !f.sortStable && t.slice(0), t.sort(O), c) {
                    ...
                    return 1 === g && 0 === m ? function (t) {
                        ...
                        if (u) {
                            ...
                            if (l = [y ? u.firstChild : u.lastChild], y && d) {
                                for (f = (a = (i = (r = (o = (s = u)[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]) && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0) || l.pop();) if (1 === s.nodeType && ++f && s === t) {
                                    r[p] = [S, a, f];
                                    break
                                }
                            } else if (d && (f = a = (i = (r = (o = (s = t)[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]), !1 === f) for (; (s = ++a && s && s[c] || (f = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((r = (o = s[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, f]), s !== t));) ;
                            return (f -= m) === g || f % g == 0 && 0 <= f / g
                        }
                    }
                }, PSEUDO: function (t, o) {
                    var e, s = b.pseudos[t] || b.setFilters[t.toLowerCase()] || at.error("unsupported pseudo: " + t);
                    return s[T] ? s(o) : 1 < s.length ? (e = [t, t, "", o], b.setFilters.hasOwnProperty(t.toLowerCase()) ? ct(function (t, e) {
        ...
        function bt(a, t, e) {
            ...
            return t.first ? function (t, e, n) {
                ...
                } else for (; t = t[l];) if (1 === t.nodeType || h) if (r = (o = t[T] || (t[T] = {}))[t.uniqueID] || (o[t.uniqueID] = {}), c && c === t.nodeName.toLowerCase()) t = t[l] || t; else {
        ...
        function Et(f, p, g, m, v, t) {
            return m && !m[T] && (m = Et(m)), v && !v[T] && (v = Et(v, t)), ct(function (t, e, n, i) {
                var r, o, s, a = [], l = [], c = e.length, u = t || function (t, e, n) {
                        ...
                        return n
                    }(p || "*", n.nodeType ? [n] : n, []), h = !f || !t && p ? u : xt(u, a, f, n, i),
                    d = g ? v || (t ? f : c || m) ? [] : e : h;
                if (g && g(h, d, n, i), m) for (r = xt(d, l), m(r, [], n, i), o = r.length; o--;) (s = r[o]) && (d[l[o]] = !(h[l[o]] = s));
                if (t) {
                    if (v || f) {
                        if (v) {
        ...
        function Ct(t) {
            for (var r, e, n, i = t.length, o = b.relative[t[0].type], s = o || b.relative[" "], a = o ? 1 : 0, l = bt(function (t) {
                return t === r
            }, s, !0), c = bt(function (t) {
                return -1 < M(r, t)
                ...
                return r = null, i
            }]; a < i; a++) if (e = b.relative[t[a].type]) u = [bt(wt(u), e)]; else {
                if ((e = b.filter[t[a].type].apply(null, t[a].matches))[T]) {
                    for (n = ++a; n < i && !b.relative[t[n].type]; n++) ;
                    return Et(1 < a && wt(u), 1 < a && _t(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(B, "$1"), e, a < n && Ct(t.slice(a, n)), n < i && Ct(t = t.slice(n)), n < i && _t(t))
                }
                u.push(e)
            }
            return wt(u)
        ...
        return yt.prototype = b.filters = b.pseudos, b.setFilters = new yt, p = at.tokenize = function (t, e) {
            ...
            if (!o) {
                ...
                (o = k(t, function (m, v) {
                    function t(t, e, n, i, r) {
                        var o, s, a, l = 0, c = "0", u = t && [], h = [], d = w, f = t || _ && b.find.TAG("*", r),
                            p = S += null == d ? 1 : Math.random() || .1, g = f.length;
                        for (r && (w = e === E || e || r); c !== g && null != (o = f[c]); c++) {
                            if (_ && o) {
                                for (s = 0, e || o.ownerDocument === E || (x(o), n = !C); a = m[s++];) if (a(o, e || E, n)) {
                                    i.push(o);
                                    break
                                }
                                r && (S = p)
            ...
            if (n = n || [], 1 === u.length) {
                if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (s = o[0]).type && 9 === e.nodeType && C && b.relative[o[1].type]) {
                    if (!(e = (b.find.ID(s.matches[0].replace(it, h), e) || [])[0])) return n;
                    c && (e = e.parentNode), t = t.slice(o.shift().value.length)
                }
                for (r = X.needsContext.test(t) ? 0 : o.length; r-- && (s = o[r], !b.relative[a = s.type]);) if ((l = b.find[a]) && (i = l(s.matches[0].replace(it, h), nt.test(o[0].type) && vt(e.parentNode) || e))) {
                    if (o.splice(r, 1), !(t = i.length && _t(o))) return P.apply(n, i), n;
                    break
                }
            }
            return (c || d(t, u))(i, e, !C, n, !e || nt.test(t) && vt(e.parentNode) || e), n
        }, f.sortStable = T.split("").sort(O).join("") === T, f.detectDuplicates = !!c, x(), f.sortDetached = ut(function (t) {
    ...
    (T.fn.init = function (t, e, n) {
        ...
        if (i[1]) {
            if (e = e instanceof T ? e[0] : e, T.merge(this, T.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : C, !0)), k.test(i[1]) && T.isPlainObject(e)) for (i in e) _(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
            return this
        }
        return (r = C.getElementById(i[2])) && (this[0] = r, this.length = 1), this
    }).prototype = T.fn, O = T(C);
    ...
    T.fn.extend({
        has: function (t) {
            ...
            if (!D.test(t)) for (; i < r; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (s ? -1 < s.index(n) : 1 === n.nodeType && T.find.matchesSelector(n, t))) {
                o.push(n);
                break
            }
        ...
        parent: function (t) {
            ...
            return void 0 !== t.contentDocument ? t.contentDocument : (A(t, "template") && (t = t.content || t), T.merge([], t.childNodes))
        }
    }, function (i, r) {
        T.fn[i] = function (t, e) {
            var n = T.map(this, r, t);
            return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = T.filter(e, n)), 1 < this.length && (L[i] || T.uniqueSort(n), j.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var H = /[^\x20\t\r\n\f]+/g;
    ...
    T.Callbacks = function (i) {
        i = "string" == typeof i ? function (t) {
            var n = {};
            return T.each(t.match(H) || [], function (t, e) {
                n[e] = !0
            }), n
        }(i) : T.extend({}, i);

        function n() {
            for (o = o || i.once, e = r = !0; a.length; l = -1) for (t = a.shift(); ++l < s.length;) !1 === s[l].apply(t[0], t[1]) && i.stopOnFalse && (l = s.length, t = !1);
            i.memory || (t = !1), r = !1, o && (s = t ? [] : "")
        }

        var r, t, e, o, s = [], a = [], l = -1, c = {
            add: function () {
                return s && (t && !r && (l = s.length - 1, a.push(t)), function n(t) {
                    T.each(t, function (t, e) {
                        _(e) ? i.unique && c.has(e) || s.push(e) : e && e.length && "string" !== w(e) && n(e)
                    })
        ...
        Deferred: function (t) {
                ...
                r = "pending", s = {
                    state: function () {
                            ...
                            return function () {
                                function t() {
                                    ...
                                    if (!(r < l)) {
                                        ...
                                        e = t && ("object" == typeof t || "function" == typeof t) && t.then, _(e) ? a ? e.call(t, c(l, o, M, a), c(l, o, $, a)) : (l++, e.call(t, c(l, o, M, a), c(l, o, $, a), c(l, o, M, o.notifyWith))) : (s !== M && (n = void 0, i = [t]), (a || o.resolveWith)(n, i))
                                    }
                                }
                                ...
                                var n = this, i = arguments, e = a ? t : function () {
                                    try {
                                        ...
                                        T.Deferred.exceptionHook && T.Deferred.exceptionHook(t, e.stackTrace), l <= r + 1 && (s !== $ && (n = void 0, i = [t]), o.rejectWith(n, i))
                                    }
                                };
                        ...
                        return T.Deferred(function (t) {
                            o[0][3].add(c(0, t, _(i) ? i : M, t.notifyWith)), o[1][3].add(c(0, t, _(e) ? e : M)), o[2][3].add(c(0, t, _(n) ? n : $))
                        }).promise()
                    }, promise: function (t) {
            ...
            if (n <= 1 && (q(t, s.done(e(i)).resolve, s.reject, !n), "pending" === s.state() || _(o[i] && o[i].then))) return s.then();
            for (; i--;) q(o[i], e(i), s.reject);
            return s.promise()
        }
    });
    ...
    function z() {
        C.removeEventListener("DOMContentLoaded", z), E.removeEventListener("load", z), T.ready()
    }
    ...
    }), T.ready.then = W.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? E.setTimeout(T.ready) : (C.addEventListener("DOMContentLoaded", z), E.addEventListener("load", z));
    var F = function (t, e, n, i, r, o, s) {
        var a = 0, l = t.length, c = null == n;
        if ("object" === w(n)) for (a in r = !0, n) F(t, e, a, n[a], !0, o, s); else if (void 0 !== i && (r = !0, _(i) || (s = !0), c && (e = s ? (e.call(t, i), null) : (c = e, function (t, e, n) {
            return c.call(T(t), n)
    ...
    Y.uid = 1, Y.prototype = {
        cache: function (t) {
            ...
            if ("string" == typeof e) r[K(e)] = n; else for (i in e) r[K(i)] = e[i];
            return r
        }, get: function (t, e) {
    ...
    var X = new Y, G = new Y, Z = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, J = /[A-Z]/g;
    ...
    T.extend({
        ...
        data: function (n, t) {
            ...
            if (this.length && (r = G.get(o), 1 === o.nodeType && !X.get(o, "hasDataAttrs"))) {
                for (e = s.length; e--;) s[e] && 0 === (i = s[e].name).indexOf("data-") && (i = K(i.slice(5)), tt(o, i, r[i]));
        ...
        queue: function (e, n) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;) (i = X.get(s[a], t + "queueHooks")) && i.empty && (r++, i.empty.add(n));
    ...
    function ct(t, e, n, i) {
        var r, o, s = 20, a = i ? function () {
            ...
            u = t.nodeType && (T.cssNumber[e] || "px" !== c && +l) && nt.exec(T.css(t, e));
        if (u && u[3] !== c) {
    ...
    function wt(t, e, n, i, r) {
        for (var o, s, a, l, c, u, h = e.createDocumentFragment(), d = [], f = 0, p = t.length; f < p; f++) if ((o = t[f]) || 0 === o) if ("object" === w(o)) T.merge(d, o.nodeType ? [o] : o); else if (bt.test(o)) {
            for (s = s || h.appendChild(e.createElement("div")), a = (ft.exec(o) || ["", ""])[1].toLowerCase(), l = gt[a] || gt._default, s.innerHTML = l[1] + T.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
            T.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
        } else d.push(e.createTextNode(o));
        for (h.textContent = "", f = 0; o = d[f++];) if (i && -1 < T.inArray(o, i)) r && r.push(o); else if (c = ot(o), s = mt(h.appendChild(o), "script"), c && vt(s), n) for (u = 0; o = s[u++];) pt.test(o.type || "") && n.push(o);
        return h
    }

    yt = C.createDocumentFragment().appendChild(C.createElement("div")), (_t = C.createElement("input")).setAttribute("type", "radio"), _t.setAttribute("checked", "checked"), _t.setAttribute("name", "t"), yt.appendChild(_t), y.checkClone = yt.cloneNode(!0).cloneNode(!0).lastChild.checked, yt.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !!yt.cloneNode(!0).lastChild.defaultValue;
    var xt = /^key/, Et = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ct = /^([^.]*)(?:\.(.+)|)/;
    ...
    function kt(t, r, o) {
        o ? (X.set(t, r, !1), T.event.add(t, r, {
            namespace: !1, handler: function (t) {
                var e, n, i = X.get(this, r);
                if (1 & t.isTrigger && this[r]) {
                    if (i.length) (T.event.special[r] || {}).delegateType && t.stopPropagation(); else if (i = a.call(arguments), X.set(this, r, i), e = o(this, r), this[r](), i !== (n = X.get(this, r)) || e ? X.set(this, r, !1) : n = {}, i !== n) return t.stopImmediatePropagation(), t.preventDefault(), n.value
                } else i.length && (X.set(this, r, {value: T.event.trigger(T.extend(i[0], T.Event.prototype), i.slice(1), this)}), t.stopImmediatePropagation())
            }
        })) : void 0 === X.get(t, r) && T.event.add(t, r, Tt)
    }

    T.event = {
        global: {}, add: function (e, t, n, i, r) {
            var o, s, a, l, c, u, h, d, f, p, g, m = X.get(e);
            if (m) for (n.handler && (n = (o = n).handler, r = o.selector), r && T.find.matchesSelector(rt, r), n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
                return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
            }), c = (t = (t || "").match(H) || [""]).length; c--;) f = g = (a = Ct.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (h = T.event.special[f] || {}, f = (r ? h.delegateType : h.bindType) || f, h = T.event.special[f] || {}, u = T.extend({
                type: f,
                origType: g,
                data: i,
                handler: n,
            ...
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(H) || [""]).length; c--;) if (f = g = (a = Ct.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
            ...
            load: {noBubble: !0}, click: {
                setup: function (t) {
                    var e = this || t;
                    return dt.test(e.type) && e.click && A(e, "input") && kt(e, "click", Tt), !1
                }, trigger: function (t) {
                    var e = this || t;
                    return dt.test(e.type) && e.click && A(e, "input") && kt(e, "click"), !0
                }, _default: function (t) {
                    var e = t.target;
    ...
    function Mt(t, e) {
        var n, i, r, o, s, a, l, c;
        if (1 === e.nodeType) {
            if (X.hasData(t) && (o = X.access(t), s = X.set(e, o), c = o.events)) for (r in delete s.handle, s.events = {}, c) for (n = 0, i = c[r].length; n < i; n++) T.event.add(e, r, c[r][n]);
    ...
    function $t(n, i, r, o) {
        ...
        if (p || 1 < h && "string" == typeof f && !y.checkClone && It.test(f)) return n.each(function (t) {
            var e = n.eq(t);
            p && (i[0] = f.call(this, t, e.html())), $t(e, i, r, o)
        });
        if (h && (e = (t = wt(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === t.childNodes.length && (t = e), e || o)) {
            for (a = (s = T.map(mt(t, "script"), Pt)).length; u < h; u++) l = t, u !== d && (l = T.clone(l, !0, !0), a && T.merge(s, mt(l, "script"))), r.call(n[u], l, u);
            if (a) for (c = s[s.length - 1].ownerDocument, T.map(s, Ht), u = 0; u < a; u++) l = s[u], pt.test(l.type || "") && !X.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}) : b(l.textContent.replace(jt, ""), l, c))
        }
        return n
    }

    function qt(t, e, n) {
        for (var i, r = e ? T.filter(e, t) : t, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || T.cleanData(mt(i)), i.parentNode && (n && ot(i) && vt(mt(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    ...
    T.extend({
        htmlPrefilter: function (t) {
            ...
            var i, r, o, s, a, l, c, u = t.cloneNode(!0), h = ot(t);
            if (!(y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t))) for (s = mt(u), i = 0, r = (o = mt(t)).length; i < r; i++) a = o[i], l = s[i], void 0, "input" === (c = l.nodeName.toLowerCase()) && dt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e) if (n) for (o = o || mt(t), s = s || mt(u), i = 0, r = o.length; i < r; i++) Mt(o[i], s[i]); else Mt(t, u);
            return 0 < (s = mt(u, "script")).length && vt(s, !h && mt(t, "script")), u
        }, cleanData: function (t) {
            for (var e, n, i, r = T.event.special, o = 0; void 0 !== (n = t[o]); o++) if (V(n)) {
                if (e = n[X.expando]) {
    ...
    var Rt, Wt, zt, Ft, Bt, Ut, Qt, Kt = new RegExp("^(" + et + ")(?!px)[a-z%]+$", "i"), Vt = function (t) {
    ...
    function Xt() {
        if (Qt) {
            Ut.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Qt.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", rt.appendChild(Ut).appendChild(Qt);
            var t = E.getComputedStyle(Qt);
            Rt = "1%" !== t.top, Bt = 12 === Gt(t.marginLeft), Qt.style.right = "60%", Ft = 36 === Gt(t.right), Wt = 36 === Gt(t.width), Qt.style.position = "absolute", zt = 12 === Gt(Qt.offsetWidth / 3), rt.removeChild(Ut), Qt = null
        }
    }
    ...
    function Zt(t, e, n) {
        ...
        return (n = n || Vt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || ot(t) || (s = T.style(t, e)), !y.pixelBoxStyles() && Kt.test(s) && Yt.test(e) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    Ut = C.createElement("div"), (Qt = C.createElement("div")).style && (Qt.style.backgroundClip = "content-box", Qt.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Qt.style.backgroundClip, T.extend(y, {
    ...
    function ue(t, e, n) {
        var i = Vt(t), r = (!y.boxSizingReliable() || n) && "border-box" === T.css(t, "boxSizing", !1, i), o = r,
            s = Zt(t, e, i), a = "offset" + e[0].toUpperCase() + e.slice(1);
        if (Kt.test(s)) {
            if (!n) return s;
            s = "auto"
        }
        return (!y.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === T.css(t, "display", !1, i)) && t.getClientRects().length && (r = "border-box" === T.css(t, "boxSizing", !1, i), (o = a in t) && (s = t[a])), (s = parseFloat(s) || 0) + ce(t, e, n || (r ? "border" : "content"), o, i, s) + "px"
    }
    ...
    T.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, o, s, a = K(e), l = oe.test(e), c = t.style;
                if (l || (e = ie(a)), s = T.cssHooks[e] || T.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(t, !1, i)) ? r : c[e];
                "string" === (o = typeof n) && (r = nt.exec(n)) && r[1] && (n = ct(t, e, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (T.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? c.setProperty(e, n) : c[e] = n))
            }
        },
        css: function (t, e, n, i) {
            var r, o, s, a = K(e);
            return oe.test(e) || (e = ie(a)), (s = T.cssHooks[e] || T.cssHooks[a]) && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = Zt(t, e, i)), "normal" === r && e in ae && (r = ae[e]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), T.each(["height", "width"], function (t, l) {
        T.cssHooks[l] = {
            get: function (t, e, n) {
                if (e) return !re.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ue(t, l, n) : at(t, se, function () {
                    return ue(t, l, n)
                })
            }, set: function (t, e, n) {
        ...
        constructor: he, init: function (t, e, n, i, r, o) {
    ...
    var de, fe, pe, ge, me = /^(?:toggle|show|hide)$/, ve = /queueHooks$/;

    function ye() {
        fe && (!1 === C.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(ye) : E.setTimeout(ye, T.fx.interval), T.fx.tick())
    }
    ...
    function xe(o, t, e) {
        var n, s, i = 0, r = xe.prefilters.length, a = T.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (s) return !1;
            for (var t = de || _e(), e = Math.max(0, c.startTime + c.duration - t), n = 1 - (e / c.duration || 0), i = 0, r = c.tweens.length; i < r; i++) c.tweens[i].run(n);
        ...
        for (!function (t, e) {
            var n, i, r, o, s;
            for (n in t) if (r = e[i = K(n)], o = t[n], Array.isArray(o) && (r = o[1], o = t[n] = o[0]), n !== i && (t[i] = o, delete t[n]), (s = T.cssHooks[i]) && "expand" in s) for (n in o = s.expand(o), delete t[i], o) n in t || (t[n] = o[n], e[n] = r); else e[i] = r
        }(u, c.opts.specialEasing); i < r; i++) if (n = xe.prefilters[i].call(c, o, u, c.opts)) return _(n.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
    ...
    T.Animation = T.extend(xe, {
        tweeners: {
            ...
            for (var n, i = 0, r = (t = _(t) ? (e = t, ["*"]) : t.match(H)).length; i < r; i++) n = t[i], xe.tweeners[n] = xe.tweeners[n] || [], xe.tweeners[n].unshift(e)
        }, prefilters: [function (t, e, n) {
            var i, r, o, s, a, l, c, u, h = "width" in e || "height" in e, d = this, f = {}, p = t.style,
            ...
            if ((l = !T.isEmptyObject(e)) || !T.isEmptyObject(f)) for (i in h && 1 === t.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = X.get(t, "display")), "none" === (u = T.css(t, "display")) && (c ? u = c : (ht([t], !0), c = t.style.display || c, u = T.css(t, "display"), ht([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(t, "float") && (l || (d.done(function () {
                p.display = c
            }), null == c && (u = p.display, c = "none" === u ? "" : u)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function () {
                p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
            })), l = !1, f) l || (m ? "hidden" in m && (g = m.hidden) : m = X.access(t, "fxshow", {display: c}), o && (m.hidden = !g), g && ht([t], !0), d.done(function () {
                for (i in g || ht([t]), X.remove(t, "fxshow"), f) T.style(t, i, f[i])
        ...
        fadeTo: function (t, e, n, i) {
            ...
            return "string" != typeof r && (o = t, t = r, r = void 0), t && !1 !== r && this.queue(r || "fx", []), this.each(function () {
                var t = !0, e = null != r && r + "queueHooks", n = T.timers, i = X.get(this);
            ...
            return !1 !== s && (s = s || "fx"), this.each(function () {
                var t, e = X.get(this), n = e[s + "queue"], i = e[s + "queueHooks"], r = T.timers, o = n ? n.length : 0;
    ...
    T.fn.extend({
        ...
        attr: function (t, e, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === t.getAttribute ? T.prop(t, e, n) : (1 === o && T.isXMLDoc(t) || (r = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? Ee : void 0)), void 0 !== n ? null === n ? void T.removeAttr(t, e) : r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : r && "get" in r && null !== (i = r.get(t, e)) ? i : null == (i = T.find.attr(t, e)) ? void 0 : i)
        }, attrHooks: {
            type: {
                set: function (t, e) {
    ...
    T.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ((t = ke(e)).length) for (; n = this[l++];) if (r = Ae(n), i = 1 === n.nodeType && " " + De(r) + " ") {
            ...
            return "boolean" == typeof e && s ? e ? this.addClass(r) : this.removeClass(r) : _(r) ? this.each(function (t) {
                T(this).toggleClass(r.call(this, t, Ae(this), e), e)
            }) : this.each(function () {
                var t, e, n, i;
                if (s) for (e = 0, n = T(this), i = ke(r); t = i[e++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t); else void 0 !== r && "boolean" != o || ((t = Ae(this)) && X.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === r ? "" : X.get(this, "__className__") || ""))
            })
        }, hasClass: function (t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++];) if (1 === n.nodeType && -1 < (" " + De(Ae(n)) + " ").indexOf(e)) return !0;
            return !1
        }
    });
    var Ne = /\r/g;
    ...
    T.extend(T.event, {
        trigger: function (t, e, n, i) {
            var r, o, s, a, l, c, u, h, d = [n || C], f = v.call(t, "type") ? t.type : t,
                p = v.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = h = s = n = n || C, 3 !== n.nodeType && 8 !== n.nodeType && !Ie.test(f + T.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), l = f.indexOf(":") < 0 && "on" + f, (t = t[T.expando] ? t : new T.Event(f, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : T.makeArray(e, [t]), u = T.event.special[f] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
                if (!i && !u.noBubble && !g(n)) {
                    for (a = u.delegateType || f, Ie.test(a + f) || (o = o.parentNode); o; o = o.parentNode) d.push(o), s = o;
                    s === (n.ownerDocument || C) && d.push(s.defaultView || s.parentWindow || E)
                }
                for (r = 0; (o = d[r++]) && !t.isPropagationStopped();) h = o, t.type = 1 < r ? a : u.bindType || f, (c = (X.get(o, "events") || {})[t.type] && X.get(o, "handle")) && c.apply(o, e), (c = l && o[l]) && c.apply && V(o) && (t.result = c.apply(o, e), !1 === t.result && t.preventDefault());
                return t.type = f, i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), e) || !V(n) || l && _(n[f]) && !g(n) && ((s = n[l]) && (n[l] = null), T.event.triggered = f, t.isPropagationStopped() && h.addEventListener(f, Oe), n[f](), t.isPropagationStopped() && h.removeEventListener(f, Oe), T.event.triggered = void 0, s && (n[l] = s)), t.result
            }
    ...
    var je = E.location, Le = Date.now(), Pe = /\?/;
    ...
    function Re(n, t, i, r) {
        ...
        if (Array.isArray(t)) T.each(t, function (t, e) {
            i || He.test(n) ? r(n, e) : Re(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, r)
    ...
    T.param = function (t, e) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !T(this).is(":disabled") && qe.test(this.nodeName) && !$e.test(t) && (this.checked || !dt.test(t))
            }).map(function (t, e) {
                var n = T(this).val();
    ...
    var We = /%20/g, ze = /#.*$/, Fe = /([?&])_=[^&]*/, Be = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ue = /^(?:GET|HEAD)$/,
        Qe = /^\/\//, Ke = {}, Ve = {}, Ye = "*/".concat("*"), Xe = C.createElement("a");

    function Ge(o) {
        return function (t, e) {
            "string" != typeof t && (e = t, t = "*");
            var n, i = 0, r = t.toLowerCase().match(H) || [];
            if (_(e)) for (; n = r[i++];) "+" === n[0] ? (n = n.slice(1) || "*", (o[n] = o[n] || []).unshift(e)) : (o[n] = o[n] || []).push(e)
        }
    }
    ...
    Xe.href = je.href, T.extend({
        ...
        ajax: function (t, e) {
            ...
            var u, h, d, n, f, i, p, g, r, o, m = T.ajaxSetup({}, e), v = m.context || m,
                y = m.context && (v.nodeType || v.jquery) ? T(v) : T.event, _ = T.Deferred(),
                b = T.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", x = {
                    readyState: 0, getResponseHeader: function (t) {
                        var e;
                        if (p) {
                            if (!n) for (n = {}; e = Be.exec(d);) n[e[1].toLowerCase() + " "] = (n[e[1].toLowerCase() + " "] || []).concat(e[2]);
                            e = n[t.toLowerCase() + " "]
                        }
                        ...
                        var e;
                        if (t) if (p) x.always(t[x.status]); else for (e in t) w[e] = [w[e], t[e]];
                        return this
                    }, abort: function (t) {
                        var e = t || l;
            ...
            if (_.promise(x), m.url = ((t || m.url || je.href) + "").replace(Qe, je.protocol + "//"), m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(H) || [""], null == m.crossDomain) {
                i = C.createElement("a");
                try {
    ...
    T.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = _(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(on, "$1" + i) : !1 !== t.jsonp && (t.url += (Pe.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            return o || T.error(i + " was not called"), o[0]
        }, t.dataTypes[0] = "json", r = E[i], E[i] = function () {
            o = arguments
        }, n.always(function () {
            void 0 === r ? T(E).removeProp(i) : E[i] = r, t[i] && (t.jsonpCallback = e.jsonpCallback, rn.push(i)), o && _(r) && r(o[0]), o = r = void 0
        }), "script"
    }), y.createHTMLDocument = ((nn = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === nn.childNodes.length), T.parseHTML = function (t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (y.createHTMLDocument ? ((i = (e = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href, e.head.appendChild(i)) : e = C), o = !n && [], (r = k.exec(t)) ? [e.createElement(r[1])] : (r = wt([t], e, o), o && o.length && T(o).remove(), T.merge([], r.childNodes)));
        var i, r, o
    }, T.fn.load = function (t, e, n) {
        var i, r, o, s = this, a = t.indexOf(" ");
        return -1 < a && (i = De(t.slice(a)), t = t.slice(0, a)), _(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), 0 < s.length && T.ajax({
            url: t,
            type: r || "GET",
            dataType: "html",
            data: e
        ...
        T.cssHooks[n] = Jt(y.pixelPosition, function (t, e) {
            if (e) return e = Zt(t, n), Kt.test(e) ? T(t).position()[n] + "px" : e
        })
    ...
    }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = A, T.isFunction = _, T.isWindow = g, T.camelCase = K, T.type = w, T.now = Date.now, T.isNumeric = function (t) {
        var e = T.type(t);
    ...
    return T.noConflict = function (t) {
        return E.$ === T && (E.$ = an), t && E.jQuery === T && (E.jQuery = sn), T
    }, t || (E.jQuery = E.$ = T), T
}), function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.Popper = e()
}(this, function () {
    "use strict";
    for (var t = "undefined" != typeof window && "undefined" != typeof document, e = ["Edge", "Trident", "Firefox"], n = 0, i = 0; i < e.length; i += 1) if (t && 0 <= navigator.userAgent.indexOf(e[i])) {
        n = 1;
        break
    }
    ...
    function v(t, e) {
        ...
        if (t !== s && e !== s || i.contains(r)) return function (t) {
            var e = t.nodeName;
            return "BODY" !== e && ("HTML" === e || _(t.firstElementChild) === t)
        }(s) ? s : _(s);
        var a = l(t);
    ...
    function w(t) {
        var e = t.body, n = t.documentElement, i = m(10) && getComputedStyle(n);
    ...
    function T(t) {
        ...
        var r = {left: e.left, top: e.top, width: e.right - e.left, height: e.bottom - e.top},
            o = "HTML" === t.nodeName ? w(t.ownerDocument) : {}, s = o.width || t.clientWidth || r.right - r.left,
    ...
    function S(t, e, n) {
        var i = 2 < arguments.length && void 0 !== n && n, r = m(10), o = "HTML" === e.nodeName, s = T(t), a = T(e),
            l = g(t), c = b(e), u = parseFloat(c.borderTopWidth, 10), h = parseFloat(c.borderLeftWidth, 10);
        i && o && (a.top = Math.max(a.top, 0), a.left = Math.max(a.left, 0));
        var d = C({top: s.top - a.top - u, left: s.left - a.left - h, width: s.width, height: s.height});
        ...
        return (r && !i ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (d = function (t, e, n) {
            var i = 2 < arguments.length && void 0 !== n && n, r = y(e, "top"), o = y(e, "left"), s = i ? -1 : 1;
    ...
    function f(t, e, n, i, r) {
        var o = 4 < arguments.length && void 0 !== r && r, s = {top: 0, left: 0}, a = o ? D(t) : v(t, e);
        if ("viewport" === i) s = function (t, e) {
            var n = 1 < arguments.length && void 0 !== e && e, i = t.ownerDocument.documentElement, r = S(t, i),
                o = Math.max(i.clientWidth, window.innerWidth || 0),
                s = Math.max(i.clientHeight, window.innerHeight || 0), a = n ? 0 : y(i), l = n ? 0 : y(i, "left");
            return C({top: a - r.top + r.marginTop, left: l - r.left + r.marginLeft, width: o, height: s})
        }(a, o); else {
            var l = void 0;
            ...
            if ("HTML" !== l.nodeName || function t(e) {
                ...
                var u = w(t.ownerDocument), h = u.height, d = u.width;
    ...
    function I(t, e, n) {
        n = n.split("-")[0];
        var i = N(t), r = {width: i.width, height: i.height}, o = -1 !== ["right", "left"].indexOf(n),
            s = o ? "top" : "left", a = o ? "left" : "top", l = o ? "height" : "width", c = o ? "width" : "height";
        return r[s] = e[s] + e[l] / 2 - i[l] / 2, r[a] = n === a ? e[a] - i[c] : e[O(a)], r
    }
    ...
    function L(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function (t, e, n) {
            ...
            t.enabled && s(e) && (n.offsets.popper = C(n.offsets.popper), n.offsets.reference = C(n.offsets.reference), n = e(n, t))
        }), n
    }
    ...
    function $(t, e, n, i) {
        ...
        return function t(e, n, i, r) {
            ...
            s.addEventListener(n, i, {passive: !0}), o || t(g(s.parentNode), n, i, r), r.push(s)
    ...
    function W(n, i) {
        Object.keys(i).forEach(function (t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && R(i[t]) && (e = "px"), n.style[t] = i[t] + e
        })
    }
    ...
    function Q(t, e) {
        var n = 1 < arguments.length && void 0 !== e && e, i = U.indexOf(t), r = U.slice(i + 1).concat(U.slice(0, i));
        return n ? r.reverse() : r
    }

    var K = "flip", V = "clockwise", Y = "counterclockwise";
        ...
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                ...
                order: 200, enabled: !0, fn: function (t, e) {
                    ...
                    return l = R(+n) ? [+n, 0] : X(n, o, s, a), "left" === a ? (o.top += l[0], o.left -= l[1]) : "right" === a ? (o.top += l[0], o.left += l[1]) : "top" === a ? (o.left += l[0], o.top -= l[1]) : "bottom" === a && (o.left += l[0], o.top += l[1]), t.popper = o, t
                }, offset: 0
            }, preventOverflow: {
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var r = t.placement.split("-")[0], o = t.offsets, s = o.popper, a = o.reference,
                        ...
                        h = u.toLowerCase(), d = l ? "left" : "top", f = l ? "bottom" : "right", p = N(i)[c];
                    a[f] - p < s[h] && (t.offsets.popper[h] -= s[h] - (a[f] - p)), a[h] + p > s[f] && (t.offsets.popper[h] += a[h] + p - s[f]), t.offsets.popper = C(t.offsets.popper);
                    var g = a[h] + a[c] / 2 - p / 2, m = b(t.instance.popper), v = parseFloat(m["margin" + u], 10),
                        y = parseFloat(m["border" + u + "Width"], 10), _ = g - t.offsets.popper[h] - v - y;
                    return _ = Math.max(Math.min(s[c] - p, _), 0), t.arrowElement = i, t.offsets.arrow = (x(n = {}, h, Math.round(_)), x(n, d, ""), n), t
                }, element: "[x-arrow]"
            }, flip: {
                order: 600,
                enabled: !0,
                fn: function (g, m) {
                    ...
                    var v = f(g.instance.popper, g.instance.reference, m.padding, m.boundariesElement, g.positionFixed),
                        y = g.placement.split("-")[0], _ = O(y), b = g.placement.split("-")[1] || "", w = [];
                    switch (m.behavior) {
                        case K:
                            w = [y, _];
                            break;
                    ...
                    return w.forEach(function (t, e) {
                        ...
                        var n = g.offsets.popper, i = g.offsets.reference, r = Math.floor,
                            ...
                            d = !!m.flipVariations && (h && "start" === b && s || h && "end" === b && a || !h && "start" === b && l || !h && "end" === b && c),
                            f = !!m.flipVariationsByContent && (h && "start" === b && a || h && "end" === b && s || !h && "start" === b && c || !h && "end" === b && l),
                            p = d || f;
                        (o || u || p) && (g.flipped = !0, (o || u) && (y = w[e + 1]), p && (b = function (t) {
                            return "end" === t ? "start" : "start" === t ? "end" : t
                        }(b)), g.placement = y + (b ? "-" + b : ""), g.offsets.popper = E({}, g.offsets.popper, I(g.instance.popper, g.offsets.reference, g.placement)), g = L(g.instance.modifiers, g, "flip"))
                    }), g
                },
                behavior: "flip",
                padding: 5,
                ...
                order: 700, enabled: !1, fn: function (t) {
                    ...
                    return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), t.placement = O(e), t.offsets.popper = C(r), t
                }
            }, hide: {
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    ...
                    var s = void 0 !== o ? o : e.gpuAcceleration, a = _(t.instance.popper), l = T(a),
                        c = {position: r.position}, u = function (t, e) {
                            function n(t) {
                                return t
                            }

                            var i = t.offsets, r = i.popper, o = i.reference, s = Math.round, a = Math.floor,
                                l = s(o.width), c = s(r.width), u = -1 !== ["left", "right"].indexOf(t.placement),
                                h = -1 !== t.placement.indexOf("-"), d = e ? u || h || l % 2 == c % 2 ? s : a : n,
                                f = e ? s : n;
                            return {
                        ...
                        }(t, window.devicePixelRatio < 2 || !z), h = "bottom" === n ? "top" : "bottom",
                        d = "right" === i ? "left" : "right", f = H("transform"), p = void 0, g = void 0;
                    ...
                    return t.attributes = E({}, y, t.attributes), t.styles = E({}, c, t.styles), t.arrowStyles = E({}, t.offsets.arrow, t.arrowStyles), t
                }, gpuAcceleration: !0, x: "bottom", y: "right"
            }, applyStyle: {
                order: 900, enabled: !0, fn: function (t) {
                    return W(t.instance.popper, t.styles), function (e, n) {
        ...
        key: "update", value: function () {
            return function () {
                if (!this.state.isDestroyed) {
                    ...
                    t.offsets.reference = k(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = A(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = I(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = L(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
                }
            }.call(this)
        }
    }, {
    ...
    function J(t, e) {
        ...
        !function (t, e) {
            ...
            isCreated: !1,
            scrollParents: []
        }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(E({}, J.Defaults.modifiers, i.modifiers)).forEach(function (t) {
            n.options.modifiers[t] = E({}, J.Defaults.modifiers[t] || {}, i.modifiers ? i.modifiers[t] : {})
    ...
    return Z.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Z.placements = B, Z.Defaults = G, Z
}), function (t, e) {
    ...
    var r = "alert", o = "bs.alert", a = "." + o, c = p.fn[r],
        u = {CLOSE: "close" + a, CLOSED: "closed" + a, CLICK_DATA_API: "click" + a + ".data-api"}, d = "alert",
        f = "fade", m = "show", v = function () {
            function i(t) {
                this._element = t
            }
    ...
    var y = "button", _ = "bs.button", b = "." + _, w = ".data-api", x = p.fn[y], E = "active", C = "btn", T = "focus",
        S = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', A = 'input:not([type="hidden"])', k = ".active",
        N = ".btn", O = {CLICK_DATA_API: "click" + b + w, FOCUS_BLUR_DATA_API: "focus" + b + w + " blur" + b + w},
        I = function () {
            function n(t) {
                this._element = t
            }
            ...
            return t.toggle = function () {
                ...
                if (n) {
                    ...
                    if (i) {
                        if ("radio" === i.type) if (i.checked && this._element.classList.contains(E)) t = !1; else {
                ...
                e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(E)), t && p(this._element).toggleClass(E)
            }, t.dispose = function () {
    ...
    p(document).on(O.CLICK_DATA_API, S, function (t) {
        t.preventDefault();
        var e = t.target;
        p(e).hasClass(C) || (e = p(e).closest(N)), I._jQueryInterface.call(p(e), "toggle")
    }).on(O.FOCUS_BLUR_DATA_API, S, function (t) {
        var e = p(t.target).closest(N)[0];
        p(e).toggleClass(T, /^focus(in)?$/.test(t.type))
    }), p.fn[y] = I._jQueryInterface, p.fn[y].Constructor = I, p.fn[y].noConflict = function () {
        return p.fn[y] = x, I._jQueryInterface
    };
    var j = "carousel", L = "bs.carousel", P = "." + L, H = ".data-api", M = p.fn[j],
        $ = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, q = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, R = "next", W = "prev", z = "left", F = "right", B = {
            SLIDE: "slide" + P,
            SLID: "slid" + P,
            KEYDOWN: "keydown" + P,
        ...
        }, U = "carousel", Q = "active", K = "slide", V = "carousel-item-right", Y = "carousel-item-left",
        X = "carousel-item-next", G = "carousel-item-prev", Z = "pointer-event", J = ".active",
        tt = ".active.carousel-item", et = ".carousel-item", nt = ".carousel-item img",
        it = ".carousel-item-next, .carousel-item-prev", rt = ".carousel-indicators",
        ot = "[data-slide], [data-slide-to]", st = '[data-ride="carousel"]', at = {TOUCH: "touch", PEN: "pen"},
        lt = function () {
            function o(t, e) {
            ...
            return t.next = function () {
                ...
                return t = l({}, $, t), g.typeCheckConfig(j, t, q), t
                ...
                if (this._touchSupported) {
                    ...
                    p(this._element.querySelectorAll(nt)).on(B.DRAG_START, function (t) {
                        return t.preventDefault()
                    }), this._pointerEvent ? (p(this._element).on(B.POINTERDOWN, function (t) {
                        return n(t)
                    }), p(this._element).on(B.POINTERUP, function (t) {
                        return i(t)
                    }), this._element.classList.add(Z)) : (p(this._element).on(B.TOUCHSTART, function (t) {
                        return n(t)
                ...
                var n = t === R, i = t === W, r = this._getItemIndex(e), o = this._items.length - 1;
                if ((i && 0 === r || n && r === o) && !this._config.wrap) return e;
                var s = (r + (t === W ? -1 : 1)) % this._items.length;
                ...
                var n, i, r, o = this, s = this._element.querySelector(tt), a = this._getItemIndex(s),
                    l = e || s && this._getItemByDirection(t, s), c = this._getItemIndex(l),
                    u = Boolean(this._interval);
                if (r = t === R ? (n = Y, i = X, z) : (n = V, i = G, F), l && p(l).hasClass(Q)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                    this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l);
                    var h = p.Event(B.SLID, {relatedTarget: l, direction: r, from: a, to: c});
                ...
                return this.each(function () {
                    var t = p(this).data(L), e = l({}, $, p(this).data());
                    "object" == typeof i && (e = l({}, e, i));
                    var n = "string" == typeof i ? i : e.slide;
                    if (t || (t = new o(this, e), p(this).data(L, t)), "number" == typeof i) t.to(i); else if ("string" == typeof n) {
                ...
                if (e) {
                    ...
                    if (n && p(n).hasClass(U)) {
                        ...
                        r && (i.interval = !1), o._jQueryInterface.call(p(n), i), r && p(n).data(L).to(r), t.preventDefault()
                    }
                }
            }, s(o, null, [{
                key: "VERSION", get: function () {
    ...
    p(document).on(B.CLICK_DATA_API, ot, lt._dataApiClickHandler), p(window).on(B.LOAD_DATA_API, function () {
        for (var t = [].slice.call(document.querySelectorAll(st)), e = 0, n = t.length; e < n; e++) {
            var i = p(t[e]);
            lt._jQueryInterface.call(i, i.data())
        }
    }), p.fn[j] = lt._jQueryInterface, p.fn[j].Constructor = lt, p.fn[j].noConflict = function () {
        return p.fn[j] = M, lt._jQueryInterface
    };
    var ct = "collapse", ut = "bs.collapse", ht = "." + ut, dt = p.fn[ct], ft = {toggle: !0, parent: ""},
        pt = {toggle: "boolean", parent: "(string|element)"}, gt = {
            SHOW: "show" + ht,
            SHOWN: "shown" + ht,
            HIDE: "hide" + ht,
            HIDDEN: "hidden" + ht,
            CLICK_DATA_API: "click" + ht + ".data-api"
        }, mt = "show", vt = "collapse", yt = "collapsing", _t = "collapsed", bt = "width", wt = "height",
        xt = ".show, .collapsing", Et = '[data-toggle="collapse"]', Ct = function () {
            function a(e, t) {
                this._isTransitioning = !1, this._element = e, this._config = this._getConfig(t), this._triggerArray = [].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
                for (var n = [].slice.call(document.querySelectorAll(Et)), i = 0, r = n.length; i < r; i++) {
            ...
            return t.toggle = function () {
                ...
                var t, e, n = this;
                if (!this._isTransitioning && !p(this._element).hasClass(mt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(xt)).filter(function (t) {
                    ...
                    var i = p.Event(gt.SHOW);
                    if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                        t && (a._jQueryInterface.call(p(t).not(this._selector), "hide"), e || p(t).data(ut, null));
                        var r = this._getDimension();
                        p(this._element).removeClass(vt).addClass(yt), this._element.style[r] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(_t).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var o = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                            s = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function () {
                            p(n._element).removeClass(yt).addClass(vt).addClass(mt), n._element.style[r] = "", n.setTransitioning(!1), p(n._element).trigger(gt.SHOWN)
                ...
                if (!this._isTransitioning && p(this._element).hasClass(mt)) {
                    var e = p.Event(gt.HIDE);
                    if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                        var n = this._getDimension();
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", g.reflow(this._element), p(this._element).addClass(yt).removeClass(vt).removeClass(mt);
                        var i = this._triggerArray.length;
                        if (0 < i) for (var r = 0; r < i; r++) {
                            var o = this._triggerArray[r], s = g.getSelectorFromElement(o);
                            if (null !== s) p([].slice.call(document.querySelectorAll(s))).hasClass(mt) || p(o).addClass(_t).attr("aria-expanded", !1)
                        }
                        this.setTransitioning(!0);
                        this._element.style[n] = "";
                        var a = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function () {
                            t.setTransitioning(!1), p(t._element).removeClass(yt).addClass(vt).trigger(gt.HIDDEN)
                ...
                p.removeData(this._element, ut), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, t._getConfig = function (t) {
                return (t = l({}, ft, t)).toggle = Boolean(t.toggle), g.typeCheckConfig(ct, t, pt), t
            }, t._getDimension = function () {
                return p(this._element).hasClass(bt) ? bt : wt
                ...
                e.length && p(e).toggleClass(_t, !n).attr("aria-expanded", n)
            }, a._getTargetFromElement = function (t) {
                var e = g.getSelectorFromElement(t);
                return e ? document.querySelector(e) : null
            }, a._jQueryInterface = function (i) {
                return this.each(function () {
                    var t = p(this), e = t.data(ut), n = l({}, ft, t.data(), "object" == typeof i && i ? i : {});
    ...
    p(document).on(gt.CLICK_DATA_API, Et, function (t) {
        "A" === t.currentTarget.tagName && t.preventDefault();
        var n = p(this), e = g.getSelectorFromElement(this), i = [].slice.call(document.querySelectorAll(e));
        p(i).each(function () {
            var t = p(this), e = t.data(ut) ? "toggle" : n.data();
            Ct._jQueryInterface.call(t, e)
        })
    }), p.fn[ct] = Ct._jQueryInterface, p.fn[ct].Constructor = Ct, p.fn[ct].noConflict = function () {
        return p.fn[ct] = dt, Ct._jQueryInterface
    };
    var Tt = "dropdown", St = "bs.dropdown", Dt = "." + St, At = ".data-api", kt = p.fn[Tt],
        Nt = new RegExp("38|40|27"), Ot = {
            HIDE: "hide" + Dt,
            HIDDEN: "hidden" + Dt,
            SHOW: "show" + Dt,
            SHOWN: "shown" + Dt,
        ...
        }, It = "disabled", jt = "show", Lt = "dropup", Pt = "dropright", Ht = "dropleft", Mt = "dropdown-menu-right",
        $t = "position-static", qt = '[data-toggle="dropdown"]', Rt = ".dropdown form", Wt = ".dropdown-menu",
        zt = ".navbar-nav", Ft = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Bt = "top-start",
        Ut = "top-end", Qt = "bottom-start", Kt = "bottom-end", Vt = "right-start", Yt = "left-start",
        Xt = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, Gt = {
            ...
            var t = c.prototype;
            return t.toggle = function () {
                if (!this._element.disabled && !p(this._element).hasClass(It)) {
                    var t = c._getParentFromElement(this._element), e = p(this._menu).hasClass(jt);
                    if (c._clearMenus(), !e) {
                        var n = {relatedTarget: this._element}, i = p.Event(Ot.SHOW, n);
                        if (p(t).trigger(i), !i.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                if (void 0 === h) throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper.js.org/)");
                                var r = this._element;
                                "parent" === this._config.reference ? r = t : g.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(t).addClass($t), this._popper = new h(r, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === p(t).closest(zt).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(jt), p(t).toggleClass(jt).trigger(p.Event(Ot.SHOWN, n))
                        }
                    }
                }
            }, t.show = function () {
                if (!(this._element.disabled || p(this._element).hasClass(It) || p(this._menu).hasClass(jt))) {
                    var t = {relatedTarget: this._element}, e = p.Event(Ot.SHOW, t),
                        n = c._getParentFromElement(this._element);
                    p(n).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(jt), p(n).toggleClass(jt).trigger(p.Event(Ot.SHOWN, t)))
                }
            }, t.hide = function () {
                if (!this._element.disabled && !p(this._element).hasClass(It) && p(this._menu).hasClass(jt)) {
                    var t = {relatedTarget: this._element}, e = p.Event(Ot.HIDE, t),
                        n = c._getParentFromElement(this._element);
                    p(n).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(jt), p(n).toggleClass(jt).trigger(p.Event(Ot.HIDDEN, t)))
                }
            }, t.dispose = function () {
                ...
                var e = this;
                p(this._element).on(Ot.CLICK, function (t) {
                    t.preventDefault(), t.stopPropagation(), e.toggle()
                })
            }, t._getConfig = function (t) {
                return t = l({}, this.constructor.Default, p(this._element).data(), t), g.typeCheckConfig(Tt, t, this.constructor.DefaultType), t
                ...
                var t = p(this._element.parentNode), e = Qt;
                return t.hasClass(Lt) ? (e = Bt, p(this._menu).hasClass(Mt) && (e = Ut)) : t.hasClass(Pt) ? e = Vt : t.hasClass(Ht) ? e = Yt : p(this._menu).hasClass(Mt) && (e = Kt), e
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new c(this, "object" == typeof e ? e : null), p(this).data(St, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
            }, c._clearMenus = function (t) {
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var e = [].slice.call(document.querySelectorAll(qt)), n = 0, i = e.length; n < i; n++) {
                    var r = c._getParentFromElement(e[n]), o = p(e[n]).data(St), s = {relatedTarget: e[n]};
                    if (t && "click" === t.type && (s.clickEvent = t), o) {
                        var a = o._menu;
                        if (p(r).hasClass(jt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(r, t.target))) {
                            var l = p.Event(Ot.HIDE, s);
                            p(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[n].setAttribute("aria-expanded", "false"), p(a).removeClass(jt), p(r).removeClass(jt).trigger(p.Event(Ot.HIDDEN, s)))
                        }
                    }
                }
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(Wt).length)) : Nt.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(It))) {
                    var e = c._getParentFromElement(this), n = p(e).hasClass(jt);
                    if (n && (!n || 27 !== t.which && 32 !== t.which)) {
                        var i = [].slice.call(e.querySelectorAll(Ft));
                        if (0 !== i.length) {
    ...
    p(document).on(Ot.KEYDOWN_DATA_API, qt, Zt._dataApiKeydownHandler).on(Ot.KEYDOWN_DATA_API, Wt, Zt._dataApiKeydownHandler).on(Ot.CLICK_DATA_API + " " + Ot.KEYUP_DATA_API, Zt._clearMenus).on(Ot.CLICK_DATA_API, qt, function (t) {
        t.preventDefault(), t.stopPropagation(), Zt._jQueryInterface.call(p(this), "toggle")
    }).on(Ot.CLICK_DATA_API, Rt, function (t) {
        t.stopPropagation()
    }), p.fn[Tt] = Zt._jQueryInterface, p.fn[Tt].Constructor = Zt, p.fn[Tt].noConflict = function () {
        return p.fn[Tt] = kt, Zt._jQueryInterface
    };
    var Jt = "modal", te = "bs.modal", ee = "." + te, ne = p.fn[Jt],
        ...
        ue = "fade", he = "show", de = ".modal-dialog", fe = ".modal-body", pe = '[data-toggle="modal"]',
        ge = '[data-dismiss="modal"]', me = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", ve = ".sticky-top",
        ye = function () {
            function r(t, e) {
            ...
            return t.toggle = function (t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    p(this._element).hasClass(ue) && (this._isTransitioning = !0);
                    var n = p.Event(oe.SHOW, {relatedTarget: t});
                    p(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(oe.CLICK_DISMISS, ge, function (t) {
                        return e.hide(t)
                    }), p(this._dialog).on(oe.MOUSEDOWN_DISMISS, function () {
                        p(e._element).one(oe.MOUSEUP_DISMISS, function (t) {
                ...
                if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        this._isShown = !1;
                        var i = p(this._element).hasClass(ue);
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(oe.FOCUSIN), p(this._element).removeClass(he), p(this._element).off(oe.CLICK_DISMISS), p(this._dialog).off(oe.MOUSEDOWN_DISMISS), i) {
                ...
                [window, this._element, this._dialog].forEach(function (t) {
                    return p(t).off(ee)
                }), p(document).off(oe.FOCUSIN), p.removeData(this._element, te), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, t.handleUpdate = function () {
                this._adjustDialog()
            }, t._getConfig = function (t) {
                return t = l({}, ie, t), g.typeCheckConfig(Jt, t, re), t
            }, t._showElement = function (t) {
                var e = this, n = p(this._element).hasClass(ue);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(se) ? this._dialog.querySelector(fe).scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), p(this._element).addClass(he), this._config.focus && this._enforceFocus();

                function i() {
                    e._config.focus && e._element.focus(), e._isTransitioning = !1, p(e._element).trigger(r)
                }

                var r = p.Event(oe.SHOWN, {relatedTarget: t});
                if (n) {
                ...
                var e = this;
                p(document).off(oe.FOCUSIN).on(oe.FOCUSIN, function (t) {
                    document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function () {
                var e = this;
                this._isShown && this._config.keyboard ? p(this._element).on(oe.KEYDOWN_DISMISS, function (t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || p(this._element).off(oe.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function () {
                var e = this;
                this._isShown ? p(window).on(oe.RESIZE, function (t) {
                    return e.handleUpdate(t)
                }) : p(window).off(oe.RESIZE)
            }, t._hideModal = function () {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    p(document.body).removeClass(ce), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(oe.HIDDEN)
                })
            }, t._removeBackdrop = function () {
                this._backdrop && (p(this._backdrop).remove(), this._backdrop = null)
            }, t._showBackdrop = function (t) {
                var e = this, n = p(this._element).hasClass(ue) ? ue : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = le, n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(oe.CLICK_DISMISS, function (t) {
                        e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide())
                    }), n && g.reflow(this._backdrop), p(this._backdrop).addClass(he), !t) return;
                    if (!n) return void t();
                    var i = g.getTransitionDurationFromElement(this._backdrop);
                    p(this._backdrop).one(g.TRANSITION_END, t).emulateTransitionEnd(i)
                } else if (!this._isShown && this._backdrop) {
                    p(this._backdrop).removeClass(he);
                    var r = function () {
                        e._removeBackdrop(), t && t()
                    };
                    if (p(this._element).hasClass(ue)) {
                ...
                return this.each(function () {
                    var t = p(this).data(te), e = l({}, ie, p(this).data(), "object" == typeof n && n ? n : {});
                    if (t || (t = new r(this, e), p(this).data(te, t)), "string" == typeof n) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n](i)
    ...
    p(document).on(oe.CLICK_DATA_API, pe, function (t) {
        var e, n = this, i = g.getSelectorFromElement(this);
        i && (e = document.querySelector(i));
        var r = p(e).data(te) ? "toggle" : l({}, p(e).data(), p(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var o = p(e).one(oe.SHOW, function (t) {
            t.isDefaultPrevented() || o.one(oe.HIDDEN, function () {
                p(n).is(":visible") && n.focus()
            })
        });
        ye._jQueryInterface.call(p(e), r, this)
    }), p.fn[Jt] = ye._jQueryInterface, p.fn[Jt].Constructor = ye, p.fn[Jt].noConflict = function () {
        return p.fn[Jt] = ne, ye._jQueryInterface
    };
    var _e = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], be = {
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function (t, e) {
            ...
            r.forEach(function (t) {
                !function (t, e) {
                    ...
                    if (-1 !== e.indexOf(n)) return -1 === _e.indexOf(n) || Boolean(t.nodeValue.match(we) || t.nodeValue.match(xe));
    ...
    var Ce = "tooltip", Te = "bs.tooltip", Se = "." + Te, De = p.fn[Ce], Ae = "bs-tooltip",
        ke = new RegExp("(^|\\s)" + Ae + "\\S+", "g"), Ne = ["sanitize", "whiteList", "sanitizeFn"], Oe = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object"
        }, Ie = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, je = {
            animation: !0,
        ...
        }, Me = "fade", $e = "show", qe = ".tooltip-inner", Re = ".arrow", We = "hover", ze = "focus", Fe = "click",
        Be = "manual", Ue = function () {
            function i(t, e) {
            ...
            return t.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    }), p(r).addClass($e), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                    var c = function () {
                        e.config.animation && e._fixTransition();
                        var t = e._hoverState;
                        e._hoverState = null, p(e.element).trigger(e.constructor.Event.SHOWN), t === Pe && e._leave(null, e)
                    };
                ...
                function e() {
                    n._hoverState !== Le && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), p(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
                }

                var n = this, i = this.getTipElement(), r = p.Event(this.constructor.Event.HIDE);
                if (p(this.element).trigger(r), !r.isDefaultPrevented()) {
                    if (p(i).removeClass($e), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Fe] = !1, this._activeTrigger[ze] = !1, this._activeTrigger[We] = !1, p(this.tip).hasClass(Me)) {
                ...
                p(this.getTipElement()).addClass(Ae + "-" + t)
            }, t.getTipElement = function () {
                return this.tip = this.tip || p(this.config.template)[0], this.tip
            }, t.setContent = function () {
                var t = this.getTipElement();
                this.setElementContent(p(t.querySelectorAll(qe)), this.getTitle()), p(t).removeClass(Me + " " + $e)
            }, t.setElementContent = function (t, e) {
                "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Ee(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text())
            }, t.getTitle = function () {
                ...
                (e = e || p(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusin" === t.type ? ze : We] = !0), p(e.getTipElement()).hasClass($e) || e._hoverState === Le ? e._hoverState = Le : (clearTimeout(e._timeout), e._hoverState = Le, e.config.delay && e.config.delay.show ? e._timeout = setTimeout(function () {
                    e._hoverState === Le && e.show()
                }, e.config.delay.show) : e.show())
            }, t._leave = function (t, e) {
                var n = this.constructor.DATA_KEY;
                (e = e || p(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? ze : We] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = Pe, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function () {
                ...
                return Object.keys(e).forEach(function (t) {
                    -1 !== Ne.indexOf(t) && delete e[t]
                }), "number" == typeof (t = l({}, this.constructor.Default, e, "object" == typeof t && t ? t : {})).delay && (t.delay = {
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), g.typeCheckConfig(Ce, t, this.constructor.DefaultType), t.sanitize && (t.template = Ee(t.template, t.whiteList, t.sanitizeFn)), t
            }, t._getDelegateConfig = function () {
                var t = {};
                if (this.config) for (var e in this.config) this.constructor.Default[e] !== this.config[e] && (t[e] = this.config[e]);
                return t
            }, t._cleanTipClass = function () {
                var t = p(this.getTipElement()), e = t.attr("class").match(ke);
                ...
                null === t.getAttribute("x-placement") && (p(t).removeClass(Me), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
            }, i._jQueryInterface = function (n) {
                return this.each(function () {
                    var t = p(this).data(Te), e = "object" == typeof n && n;
                    if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Te, t)), "string" == typeof n)) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n]()
                    }
                })
    ...
    p.fn[Ce] = Ue._jQueryInterface, p.fn[Ce].Constructor = Ue, p.fn[Ce].noConflict = function () {
        return p.fn[Ce] = De, Ue._jQueryInterface
    };
    var Qe = "popover", Ke = "bs.popover", Ve = "." + Ke, Ye = p.fn[Qe], Xe = "bs-popover",
        Ge = new RegExp("(^|\\s)" + Xe + "\\S+", "g"), Ze = l({}, Ue.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), Je = l({}, Ue.DefaultType, {content: "(string|element|function)"}), tn = "fade", en = "show",
        nn = ".popover-header", rn = ".popover-body", on = {
            ...
            return e.isWithContent = function () {
                ...
                p(this.getTipElement()).addClass(Xe + "-" + t)
                ...
                "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(rn), e), t.removeClass(tn + " " + en)
            }, e._getContent = function () {
                return this.element.getAttribute("data-content") || this.config.content
            }, e._cleanTipClass = function () {
                var t = p(this.getTipElement()), e = t.attr("class").match(Ge);
                null !== e && 0 < e.length && t.removeClass(e.join(""))
            }, i._jQueryInterface = function (n) {
                return this.each(function () {
                    var t = p(this).data(Ke), e = "object" == typeof n ? n : null;
                    if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Ke, t)), "string" == typeof n)) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n]()
                    }
                })
    ...
    p.fn[Qe] = sn._jQueryInterface, p.fn[Qe].Constructor = sn, p.fn[Qe].noConflict = function () {
        return p.fn[Qe] = Ye, sn._jQueryInterface
    };
    var an = "scrollspy", ln = "bs.scrollspy", cn = "." + ln, un = p.fn[an],
        hn = {offset: 10, method: "auto", target: ""},
        dn = {offset: "number", method: "string", target: "(string|element)"},
        fn = {ACTIVATE: "activate" + cn, SCROLL: "scroll" + cn, LOAD_DATA_API: "load" + cn + ".data-api"},
        pn = "dropdown-item", gn = "active", mn = '[data-spy="scroll"]', vn = ".nav, .list-group", yn = ".nav-link",
        _n = ".nav-item", bn = ".list-group-item", wn = ".dropdown", xn = ".dropdown-item", En = ".dropdown-toggle",
        Cn = "offset", Tn = "position", Sn = function () {
            function n(t, e) {
                var n = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + yn + "," + this._config.target + " " + bn + "," + this._config.target + " " + xn, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(fn.SCROLL, function (t) {
                    return n._process(t)
            ...
            return t.refresh = function () {
                var e = this, t = this._scrollElement === this._scrollElement.window ? Cn : Tn,
                ...
                if ("string" != typeof (t = l({}, hn, "object" == typeof t && t ? t : {})).target) {
                    ...
                    e || (e = g.getUID(an), p(t.target).attr("id", e)), t.target = "#" + e
                }
                return g.typeCheckConfig(an, t, dn), t
                ...
                n.hasClass(pn) ? (n.closest(wn).find(En).addClass(gn), n.addClass(gn)) : (n.addClass(gn), n.parents(vn).prev(yn + ", " + bn).addClass(gn), n.parents(vn).prev(_n).children(yn).addClass(gn)), p(this._scrollElement).trigger(fn.ACTIVATE, {relatedTarget: e})
            }, t._clear = function () {
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new n(this, "object" == typeof e && e), p(this).data(ln, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
    ...
    var Dn = "bs.tab", An = "." + Dn, kn = p.fn.tab, Nn = {
            HIDE: "hide" + An,
            HIDDEN: "hidden" + An,
            SHOW: "show" + An,
            SHOWN: "shown" + An,
            CLICK_DATA_API: "click" + An + ".data-api"
        }, On = "dropdown-menu", In = "active", jn = "disabled", Ln = "fade", Pn = "show", Hn = ".dropdown",
        Mn = ".nav, .list-group", $n = ".active", qn = "> li > .active",
        Rn = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', Wn = ".dropdown-toggle",
        zn = "> .dropdown-menu .active", Fn = function () {
            function i(t) {
                this._element = t
            }
            ...
            return t.show = function () {
                var n = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(In) || p(this._element).hasClass(jn))) {
                    var t, i, e = p(this._element).closest(Mn)[0], r = g.getSelectorFromElement(this._element);
                    if (e) {
                        var o = "UL" === e.nodeName || "OL" === e.nodeName ? qn : $n;
                        i = (i = p.makeArray(p(e).find(o)))[i.length - 1]
                    }
                    var s = p.Event(Nn.HIDE, {relatedTarget: this._element}), a = p.Event(Nn.SHOW, {relatedTarget: i});
                    if (i && p(i).trigger(s), p(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        r && (t = document.querySelector(r)), this._activate(this._element, e);
                        var l = function () {
                            var t = p.Event(Nn.HIDDEN, {relatedTarget: n._element}),
                                e = p.Event(Nn.SHOWN, {relatedTarget: i});
                ...
                var r = this, o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children($n) : p(e).find(qn))[0],
                    s = n && o && p(o).hasClass(Ln);
                if (o && s) {
                ...
                if (e) {
                    p(e).removeClass(In);
                    var i = p(e.parentNode).find(zn)[0];
                    i && p(i).removeClass(In), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
                }
                if (p(t).addClass(In), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), g.reflow(t), t.classList.contains(Ln) && t.classList.add(Pn), t.parentNode && p(t.parentNode).hasClass(On)) {
                    var r = p(t).closest(Hn)[0];
                    if (r) {
                ...
                return this.each(function () {
                    ...
                    if (e || (e = new i(this), t.data(Dn, e)), "string" == typeof n) {
    ...
    p(document).on(Nn.CLICK_DATA_API, Rn, function (t) {
        t.preventDefault(), Fn._jQueryInterface.call(p(this), "show")
    }), p.fn.tab = Fn._jQueryInterface, p.fn.tab.Constructor = Fn, p.fn.tab.noConflict = function () {
        return p.fn.tab = kn, Fn._jQueryInterface
    };
    var Bn = "toast", Un = "bs.toast", Qn = "." + Un, Kn = p.fn[Bn], Vn = {
            CLICK_DISMISS: "click.dismiss" + Qn,
            HIDE: "hide" + Qn,
            HIDDEN: "hidden" + Qn,
            SHOW: "show" + Qn,
            SHOWN: "shown" + Qn
        }, Yn = "fade", Xn = "hide", Gn = "show", Zn = "showing",
        ...
        ti = {animation: !0, autohide: !0, delay: 500}, ei = '[data-dismiss="toast"]', ni = function () {
            ...
            return t.show = function () {
                var t = this;
                p(this._element).trigger(Vn.SHOW), this._config.animation && this._element.classList.add(Yn);

                function e() {
                    t._element.classList.remove(Zn), t._element.classList.add(Gn), p(t._element).trigger(Vn.SHOWN), t._config.autohide && t.hide()
                }

                if (this._element.classList.remove(Xn), this._element.classList.add(Zn), this._config.animation) {
                    var n = g.getTransitionDurationFromElement(this._element);
                    p(this._element).one(g.TRANSITION_END, e).emulateTransitionEnd(n)
                } else e()
            }, t.hide = function (t) {
                var e = this;
                this._element.classList.contains(Gn) && (p(this._element).trigger(Vn.HIDE), t ? this._close() : this._timeout = setTimeout(function () {
                    e._close()
                }, this._config.delay))
            }, t.dispose = function () {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Gn) && this._element.classList.remove(Gn), p(this._element).off(Vn.CLICK_DISMISS), p.removeData(this._element, Un), this._element = null, this._config = null
            }, t._getConfig = function (t) {
                return t = l({}, ti, p(this._element).data(), "object" == typeof t && t ? t : {}), g.typeCheckConfig(Bn, t, this.constructor.DefaultType), t
            }, t._setListeners = function () {
                var t = this;
                p(this._element).on(Vn.CLICK_DISMISS, ei, function () {
                    return t.hide(!0)
                })
            }, t._close = function () {
                function t() {
                    e._element.classList.add(Xn), p(e._element).trigger(Vn.HIDDEN)
                }
    ...
    }(), t.Util = g, t.Alert = v, t.Button = I, t.Carousel = lt, t.Collapse = Ct, t.Dropdown = Zt, t.Modal = ye, t.Popover = sn, t.Scrollspy = Sn, t.Tab = Fn, t.Toast = ni, t.Tooltip = Ue, Object.defineProperty(t, "__esModule", {value: !0})
}), function (s) {
    "use strict";
    var e = {
        upKey: 38,
    ...
    s.scrollIt = function (t) {
        function n(t) {
            if (!(t < 0 || o < t)) {
                var e = s("[data-scroll-index=" + t + "]").offset().top + i.topOffset + i.margin;
                s("html,body").animate({scrollTop: e, easing: i.easing}, i.scrollTime)
            }
        }

        var i = s.extend(e, t), r = 0, o = s("[data-scroll-index]:last").attr("data-scroll-index");
        s(window).on("scroll", function () {
            var n = s(window).scrollTop();
            !function (t) {
                i.onPageChange && t && r != t && i.onPageChange(t), r = t, s("[data-scroll-nav]").removeClass(i.activeClass), s("[data-scroll-nav=" + t + "]").addClass(i.activeClass)
            }(s("[data-scroll-index]").filter(function (t, e) {
                return n >= s(e).offset().top + i.topOffset && n < s(e).offset().top + i.topOffset + s(e).outerHeight()
            }).first().attr("data-scroll-index"))
        }).scroll(), s(window).on("keydown", function (t) {
            var e = t.which;
            return (!s("html,body").is(":animated") || e != i.upKey && e != i.downKey) && (e == i.upKey && 0 < r ? (n(parseInt(r) - 1), !1) : !(e == i.downKey && r < o) || (n(parseInt(r) + 1), !1))
        }), s("body").on("click", "[data-scroll-nav], [data-scroll-goto]", function (t) {
            t.preventDefault(), function (t) {
                var e = s(t.target).closest("[data-scroll-nav]").attr("data-scroll-nav") || s(t.target).closest("[data-scroll-goto]").attr("data-scroll-goto");
                n(parseInt(e))
            }(t)
        })
    }
    ...
    return r = {}, n.m = i = [function (t, e, n) {
        ...
        function r() {
            if (0 < arguments.length && void 0 !== arguments[0] && arguments[0] && (g = !0), g) return p = (0, d.default)(p, m), (0, h.default)(p, m.once), p
        }
        ...
        var s = Object.assign || function (t) {
                ...
                return t
            }, a = i((i(n(1)), n(6))), l = i(n(7)), c = i(n(8)), u = i(n(9)), h = i(n(10)), d = i(n(11)), f = i(n(14)),
            p = [], g = !1, m = {
                offset: 120,
                delay: 0,
                easing: "ease",
        ...
        t.exports = {
            init: function (t) {
                ...
                return function (t) {
                    ...
                    r(!0)
                }), window.addEventListener("resize", (0, l.default)(r, m.debounceDelay, !0)), window.addEventListener("orientationchange", (0, l.default)(r, m.debounceDelay, !0)), window.addEventListener("scroll", (0, a.default)(function () {
                    (0, h.default)(p, m.once)
                }, m.throttleDelay)), m.disableMutationObserver || c.default.ready("[data-aos]", o), p)
            }, refresh: r, refreshHard: o
        }
    }, function (t, e) {
    }, , , , , function (g, t) {
        (function (t) {
            ...
            function o(i, n, t) {
                function r(t) {
                    var e = l, n = c;
                    return l = c = void 0, p = t, h = i.apply(n, e)
                }

                function o(t) {
                    var e = t - f;
                    return void 0 === f || n <= e || e < 0 || m && u <= t - p
                }

                function s() {
                    var t = E();
                    return o(t) ? e(t) : void (d = setTimeout(s, function (t) {
                        var e = n - (t - f);
                        return m ? x(e, u - (t - p)) : e
                    }(t)))
                }

                function e(t) {
                    return d = void 0, v && l ? r(t) : (l = c = void 0, h)
                }

                function a() {
                    var t = E(), e = o(t);
                    if (l = arguments, c = this, f = t, e) {
                        if (void 0 === d) return function (t) {
                            return p = t, d = setTimeout(s, n), g ? r(t) : h
                        }(f);
                        if (m) return d = setTimeout(s, n), r(f)
                    }
                    return void 0 === d && (d = setTimeout(s, n)), h
                }

                var l, c, u, h, d, f, p = 0, g = !1, m = !1, v = !0;
                if ("function" != typeof i) throw new TypeError(b);
                return n = _(n) || 0, y(t) && (g = !!t.leading, u = (m = "maxWait" in t) ? w(_(t.maxWait) || 0, n) : u, v = "trailing" in t ? !!t.trailing : v), a.cancel = function () {
                    void 0 !== d && clearTimeout(d), l = f = c = d = void (p = 0)
                }, a.flush = function () {
                    return void 0 === d ? h : e(E())
                }, a
            }
            ...
            var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                ...
                }, b = "Expected a function", r = NaN, e = "[object Symbol]", s = /^\s+|\s+$/g, a = /^[-+]0x[0-9a-f]+$/i,
                ...
                f = h || d || Function("return this")(), p = Object.prototype.toString, w = Math.max, x = Math.min,
                E = function () {
                    return f.Date.now()
                };
            g.exports = function (t, e, n) {
                var i = !0, r = !0;
        ...
        (function (t) {
            ...
            var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                    ...
                    return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
                }, r = NaN, e = "[object Symbol]", o = /^\s+|\s+$/g, s = /^[-+]0x[0-9a-f]+$/i, a = /^0b[01]+$/i,
                l = /^0o[0-7]+$/i, c = parseInt,
                u = "object" == (void 0 === t ? "undefined" : n(t)) && t && t.Object === Object && t,
                h = "object" == ("undefined" == typeof self ? "undefined" : n(self)) && self && self.Object === Object && self,
                d = u || h || Function("return this")(), f = Object.prototype.toString, w = Math.max, x = Math.min;
            p.exports = function (i, n, t) {
                function r(t) {
                    var e = l, n = c;
                    return l = c = void 0, p = t, h = i.apply(n, e)
                }
        ...
        e.default = {
            isSupported: function () {
                ...
                var n = window.document, i = new (r())(o);
                s = e, i.observe(n.documentElement, {childList: !0, subtree: !0, removedNodes: !0})
            }
        }
    }, function (t, e) {
        "use strict";
        ...
        e.default = function (t, n) {
            var i = window.pageYOffset, r = window.innerHeight;
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var i, r = n(12), o = (i = r) && i.__esModule ? i : {default: i};
        e.default = function (t, n) {
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var i, r = n(13), s = (i = r) && i.__esModule ? i : {default: i};
        e.default = function (t, e) {
            var n = 0, i = 0, r = window.innerHeight, o = {
...
}(window.Zepto || window.jQuery, window, document), function (u, t, e) {
    var n = function (t) {
    ...
    n.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, n.prototype.fetch = function (t, e) {
        ...
        function n(t) {
            '<div class="owl-video-play-icon"></div>', i = c.lazyLoad ? u("<div/>", {
        ...
        "youtube" === t.type ? (r = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg", n(r)) : "vimeo" === t.type ? u.ajax({
            type: "GET",
        ...
        this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), n = this._core.items(this._core.relative(n.index())), this._core.reset(n.index()), (e = u('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", o), e.attr("width", r), "youtube" === i.type ? e.attr("src", "//www.youtube.com/embed/" + i.id + "?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? e.attr("src", "//player.vimeo.com/video/" + i.id + "?autoplay=1") : "vzaar" === i.type && e.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"), u(e).wrap('<div class="owl-video-frame" />').insertAfter(n.find(".owl-video")), this._playing = n.addClass("owl-video-playing"))
...
}(window.Zepto || window.jQuery, window, document), function (i, r, e) {
    var n = function (t) {
    ...
    $(document).ready(function () {
        $("body").tooltip({selector: "[data-toggle=tooltip]"}), AOS.init({
            once: !0,
    ...
    "use strict";
    var e = $(".navbar-top"), n = $(window).height();
    $(window).on("scroll", function () {
        var t = $(window).scrollTop();
        n - 65 <= t ? e.addClass("nav-scroll") : e.removeClass("nav-scroll")
    }), $(document).ready(function () {
        !function () {
            var t = window.location.pathname.split("/").pop();
            switch ($('#gymCityNav a[href="' + t + '"]').addClass("active"), t) {
                case"":
    ...
    "use strict";
    $(document).ready(function () {
        $("#classDetails").on("show.bs.modal", function (t) {
            var e = $(t.relatedTarget), n = e.data("title"), i = e.data("img"), r = $(this);
            r.find(".modal-title").text(n), r.find(".modal-img").attr("src", i)
        })
    })
}(), function () {
    "use strict";
    $(document).ready(function () {
        ...
        if (t) {
            var e = {zoom: 15, center: new google.maps.LatLng(40.7804019, -73.9822179)}, n = new google.maps.Map(t, e);
            new google.maps.Size(35, 50), new google.maps.Marker({
    ...
    window.addEventListener("load", function () {
        var t = document.getElementsByClassName("free-pass-form");
